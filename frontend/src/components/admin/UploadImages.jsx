    ...
    <AdminLayout>
      ...
      <div className="row wrapper">
        <div className="col-10 col-lg-8 mt-5 mt-lg-0">
          ...
          >
            <h2 className="mb-4">Subir imagenes de producto</h2>
            ...
            <div className="mb-3">
              ...
              {imagesPreview?.length > 0 && (
                <div className="new-images my-4">
                  <p className="text-warning">Nuevas imagenes:</p>
              ...
              {uploadedImages?.length > 0 && (
                <div className="uploaded-images my-4">
                  <p className="text-success">
                    Imágenes cargadas del producto:
                  </p>
                      ...
                      <div className="col-md-3 mt-2">
                        <div className="card">
                          <img
                            src={img?.url}
                            alt="Card"
                            className="card-img-top p-2 h-[180px]"
                            style={{ width: "100%" }}
                          />
                          <button
                            style={{

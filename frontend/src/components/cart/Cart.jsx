...
const Cart = () => {
  ...
  return (
    <>
      ...
      {cartItems?.length === 0 ? (
        <h2 className="mt-5 text-4xl text-center p-2">
          Tu carro está vacío :(
        </h2>
      ) : (
        <>
          <h2 className="mt-5 text-3xl mb-3 text-center md:text-left md:mb-5">
            Tu carro tiene: <b>{cartItems?.length} items</b>
          </h2>
          ...
          <div className="row flex justify-between p-4">
            ...
            <div className="col-12 col-lg-3 my-4">
              <div id="order_summary">
                <h4 className="text-2xl mb-6 p-2">Resumen del pedido</h4>
                <hr className="mb-3" />
                <p className="mb-2">
                  Unidades:{" "}
